        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Sarah Nelviandri</a>
                    </div>
                </div>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <?php foreach ($foodProducts as $product) : ?>
                        <div class="card">
                            <img class="card-img" src="<?= $product['gambar']; ?>" alt="<?= $product['nama_barang']; ?>" style="display: block;margin-left: auto;margin-right: auto;width: 40%;">
                            <div class="card-body">
                                <h3 class="card-title"><?= $product['nama_barang']; ?></h3>
                                <p class="card-text"><strong>Harga:</strong> <?= $product['harga']; ?></p>
                                <p class="card-text"><?= $product['deskripsi']; ?></p>
                                <button class="btn btn-primary" onclick="pesanMakanan(<?= $product['id']; ?>)">Pesan</button>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
